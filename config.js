...
let config = {
  ...
  'addAssets': {
    ...
    'src/img/services/service_3_page.png': 'img/services',
    'src/img/services/service_3_page.webp': 'img/services',

    'src/img/girl_in_museum.jpg': 'img/',
    'src/img/girl_in_museum.webp': 'img/',
    'src/img/girl_sideways.jpg': 'img/',
    'src/img/girl_sideways.webp': 'img/',
    'src/img/mountains.jpg': 'img/',
    'src/img/mountains.webp': 'img/',
    'src/img/homework.png': 'img/',
    'src/img/homework.webp': 'img/',
    'src/img/girl_at_the_table.jpg': 'img/',
    'src/img/girl_at_the_table.webp': 'img/',
    'src/img/nine_faces.png': 'img/',
    'src/img/nine_faces.webp': 'img/',
    ...
    'src/img/logos/quote.svg': 'img/logos',
